...
<form method="post" action="<?php echo base_url('Master/SaveBlog');?>" enctype="multipart/form-data">
<div class="row">
...
<textarea class="form-control" name="short_description" rows="6"></textarea>
</div>
<div class="col-md-12 mb-3">
...
<div class="col-md-6 mb-3">
<label for="inputNanme4" class="form-label">Blog Position</label>
