                                                ...
                                                <div class="modal-body">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="duration" class="form-control" value="<?= set_value('duration') ?>">
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label for="position">Course Fees</label>
                                                            <input type="text" name="fee" class="form-control" value="<?= set_value('fee') ?>">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="position">Course Syllabus</label>
                                                            <textarea class="ckeditor" name="syllabus"><?= set_value('syllabus') ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="status" class="form-control">
                                                                ...
                                                                <option value="Inactive" <?php echo  set_select('status', 'Inactive'); ?>>Block</option>
                                                            </select>
