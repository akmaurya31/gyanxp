          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>Manage Member </h2>
                  <a href="<?php echo base_url('Members/addNew');?>" class="btn btn-success add_modal_button"><i class="fa fa-plus-circle"></i> Add New</a>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="row">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                	<?php echo "Added on: ".date('d-m-Y H:i:s',strtotime($li->createdOn));?></td>

                                <td>
                                	<?php echo $li->status == 0 ? "Active" : "Block";?>
                                </td>
                                <td>
                                  <a href="<?php echo base_url('Members/edit/'.$li->id);?>" class="btn btn-success btn-sm">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    <div class="modal-body">
                                      ...
                                      <form method="post" action="<?php echo base_url('Members/deleteUser/'.$li->id);?>">
