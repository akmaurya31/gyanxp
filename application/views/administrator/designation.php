            ...
            <div class="col-md-12 col-sm-12 ">
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <a href="<?php echo base_url('Designation/addNew');?>" class="btn btn-success add_modal_button"><i class="fa fa-plus-circle"></i> Add New</a>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <div class="row">
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  <a href="<?php echo base_url('Designation/edit/'.$li->id);?>" class="btn btn-success btn-sm">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    <div class="modal-body">
                                      ...
                                      <form method="post" action="<?php echo base_url('Designation/deleteUser/'.$li->id);?>">
